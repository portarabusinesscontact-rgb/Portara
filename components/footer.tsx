      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1">
            <h3 className="text-2xl font-serif font-bold mb-4">Portara</h3>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link href="/bulk" className="text-muted-foreground hover:text-foreground transition-colors">
                  Bulk Buy
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              <li>
                <a href="mailto:info@portara.org" className="hover:text-foreground transition-colors">
                  info@portara.org
                </a>
              </li>
              <li>
